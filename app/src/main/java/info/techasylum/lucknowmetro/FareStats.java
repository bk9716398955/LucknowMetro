...
public class FareStats extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fare_stats);
    ...
    public void FareCalculator(){
        ...
        if(s.length()==0&&d.length()==0||s.length()==0||d.length()==0){
            Toast.makeText(FareStats.this, "Please Fill Required Field", Toast.LENGTH_LONG).show();
        }
        else if(s.equals(d)) {
            Toast.makeText(FareStats.this, "Both Are Same Stations", Toast.LENGTH_LONG).show();
        }
        else{
    ...
    public void SendData() {
        if(list.size()!=0){
            Intent intent =new Intent(this,FareResult.class);
            ...
            Toast.makeText(FareStats.this, "Note getting any data:", Toast.LENGTH_LONG).show();
        }
        list.clear();
        station=0;
        change=0;
